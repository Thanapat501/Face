...
class Face:
    def __init__(self, app):
        ...
        self.know_encoding_faces = [] # faces data for recognition
        self.face_user_keys = {}
        self.load_all()
    ...
    def load_all(self):
        ...
        for row in results:
            ...
            index_key = len(self.know_encoding_faces)
            self.know_encoding_faces.append(face_image_encoding)
    ...
    def recognize(self, unknown_filename):
        ...
        results = face_recognition.compare_faces(self.know_encoding_faces, unknown_encoding_image)
        print(results)
        face_distances = face_recognition.face_distance(self.know_encoding_faces, unknown_encoding_image)
        ...
        for matched in results:
            if matched:
                # so we can found this user with index key and find him
